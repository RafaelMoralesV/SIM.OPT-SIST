...
\title{Uso de los Modelos como Herramienta de Apoyo en la Toma de Decisiones}
...
\input{sobre_el_Covid-19.tex}

\input{modelos_asociados.tex}

\input{modelos_predictivos.tex}

\input{Uso de modelos matemáticos.tex}
