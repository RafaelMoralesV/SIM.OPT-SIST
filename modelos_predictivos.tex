...
\input{modelos predictivos/modelo sirs.tex}
\input{modelos predictivos/modelo seir.tex}
\input{modelos predictivos/modelo carga potencial maxima.tex}
\input{modelos predictivos/modelo gompertz.tex}
\input{modelos predictivos/modelo de holt.tex}